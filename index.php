                                ...
                                <div class="modal-dialog">
                                   <div class="modal-content">
                                        ...
                                        <div class="modal-body container">
                                            <div class="col-md-8">
                                                <p><?php echo (strpos(mime_content_type($file->files[$y]["path"]), "image") !== false ? "Unable to read that file." : str_replace('1', '', htmlentities(highlight_string(file_get_contents($file->files[$y]["path"]))))); ?></p>
